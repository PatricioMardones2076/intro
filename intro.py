...
#Salida
print("Bienvenido al servicio de registro de protección del programa Secure-Tec. Soy HAX y te guiare en el proceso de tu solicitud. Por favor ingrese los siguientes datos para que su postulación quede registrada, a la brevedad uno de nuestros tecnicos evaluará su situación y las posibilidades de obtener un espacio en nuestros refugios nucleares")